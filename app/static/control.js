(() => {
  ...
  const ICONS = {
    ...
    door: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 21V5a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v16" fill="currentColor" fill-opacity="0.18"/><path d="M3 21h18"/><circle cx="14.5" cy="13" r="1.2" fill="currentColor" stroke="none"/></svg>',
